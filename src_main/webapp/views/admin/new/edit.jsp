				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="thumbnail" name="thumbnail"	value="${model.title }" />
							</div>
						</div>
						<br>
						<br>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								 <textarea rows="" cols="" id="content" name="content" style="width: 945px;height: 240px">${model.content}</textarea>
							</div>
						</div>
						<br>
						<br/>
